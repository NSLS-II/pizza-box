...
class AnalogPizzaBoxStream(AnalogPizzaBox):
    ...
    def complete(self, *args, **kwargs):
        ...
        datum = {"resource": self._resource_uid, "datum_kwargs": {}, "datum_id": datum_id}
    ...
    def collect(self):
        ...
        with self.ssh.open_sftp() as sftp:
            ...
            sftp.get("/home/Save/FAstream.bin", self.filename_bin)  # TODO: make it configurable
            print(f"Saving a text   file from {server} to {self.filename_txt}")
            sftp.get("/home/Save/FAstreamSettings.txt", self.filename_txt)  # TODO: make it configurable
